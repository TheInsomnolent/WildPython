...
Windows 
`$ cxfreeze WidgetApp/__main__.py --target-dir dist --bdist_msi`

Mac
`$ cxfreeze WidgetApp/__main__.py --target-dir dist --bdist_dmg`

Linux
`$ cxfreeze WidgetApp/__main__.py --target-dir dist`
